...
- Para modulos nuevos, partir de `odoo-module-scaffold`, revisar su plan `--dry-run` y adaptar desde contracts/adapters/services; no copiar un modulo historico como plantilla base.
