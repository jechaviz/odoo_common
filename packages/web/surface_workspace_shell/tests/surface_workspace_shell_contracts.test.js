...
for (const expectedToken of [
  ...
  "position: sticky",
  ".o_surface_collapsible_row_toggle[data-surface-busy=\"1\"]",
  "body.o_surface_workspace_active :where(.o_surface_collapsible_detail_row > .o_surface_collapsible_detail_cell)",
  "body.o_surface_workspace_active :where(.o_surface_collapsible_detail_panel)",
  "body.o_surface_workspace_active :where(.o_surface_collapsible_parent--expanded > td)",
